...
- [Spoonacular](https://spoonacular.com/) за предоставление API
- [Jetpack Compose](https://developer.android.com/jetpack/compose) команде за отличный UI фреймворк
- Сообществу Android разработчиков за вдохновение и поддержку

## 📞 Поддержка

Если у вас есть вопросы или предложения, пожалуйста:
- Откройте [Issue](https://github.com/your-username/FoodSearch/issues)
- Свяжитесь со мной через [email](mailto:your-email@example.com)
