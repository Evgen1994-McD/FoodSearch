...
@AndroidEntryPoint
class FavoriteFragment : Fragment(), OnRecipeClickListener {
...
viewModel.getRecipes()
    ...
    private fun displayTRecipes(recipes: List<RecipeSummary>) = with(binding) {
    ...
    fun getRecipeClickAndStart(recipeSummary: RecipeSummary) {
...
getRecipeClickAndStart(recipeSummary)
    }
