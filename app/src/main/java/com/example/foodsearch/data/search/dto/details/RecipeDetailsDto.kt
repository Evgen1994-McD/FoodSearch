...
data class RecipeDetailsDto(
    ...
    val extendedIngredients: List<OtherModels.Ingredient>, // Список ингредиентов
    ...
    val analyzedInstructions: List<OtherModels.AnalyzedInstruction>, // Проанализированные инструкции
